                        ...
                        <div className="sm:flex sm:items-start">
                            ...
                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div className="mt-2">
                                    ...
                                    {loading ? (
                                        <div className="text-center py-4">Loading seeds...</div>
                                    ) : (
                                        <textarea
                                            value={seeds}
                                            onChange={(e) => setSeeds(e.target.value)}
                                            rows={10}
                                            className="w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm font-mono"
